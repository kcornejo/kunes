...
/**
 * CategoriaMateria form base class.
 *
 * @method CategoriaMateria getObject() Returns the current form's model object
 *
 * @package    plan
 * @subpackage form
 * @author     Via
 */
abstract class BaseCategoriaMateriaForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('categoria_materia[%s]');
