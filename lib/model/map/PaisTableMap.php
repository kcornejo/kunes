...
class PaisTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('CODIGO_ISO', 'CodigoIso', 'VARCHAR', false, 5, null);
    ...
    {
        $this->addRelation('Usuario', 'Usuario', RelationMap::ONE_TO_MANY, array('id' => 'pais_id', ), null, null, 'Usuarios');
        $this->addRelation('Universidad', 'Universidad', RelationMap::ONE_TO_MANY, array('id' => 'pais_id', ), null, null, 'Universidads');
    } // buildRelations()
