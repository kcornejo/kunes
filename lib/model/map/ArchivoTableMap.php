...
class ArchivoTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('NOMBRE_ARCHIVO_ORIGINAL', 'NombreArchivoOriginal', 'VARCHAR', false, 50, null);
        $this->addColumn('NOMBRE_ARCHIVO_ACTUAL', 'NombreArchivoActual', 'VARCHAR', false, 50, null);
