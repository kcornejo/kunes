...
class ArchivoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lib.model.map.ArchivoTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('NOMBRE_ARCHIVO_ORIGINAL', 'NombreArchivoOriginal', 'VARCHAR', false, 100, null);
        $this->addColumn('NOMBRE_ARCHIVO_ACTUAL', 'NombreArchivoActual', 'VARCHAR', false, 100, null);
        ...
        $this->addColumn('ETIQUETA', 'Etiqueta', 'VARCHAR', false, 255, null);
        $this->addForeignKey('MATERIA_ID', 'MateriaId', 'INTEGER', 'materia', 'ID', false, null, null);
        $this->addForeignKey('PROFESORES_ID', 'ProfesoresId', 'INTEGER', 'profesores', 'ID', false, null, null);
        // validators
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Profesores', 'Profesores', RelationMap::MANY_TO_ONE, array('profesores_id' => 'id', ), null, null);
        $this->addRelation('ArchivoComentario', 'ArchivoComentario', RelationMap::ONE_TO_MANY, array('id' => 'archivo_id', ), null, null, 'ArchivoComentarios');
        $this->addRelation('ArchivoCalificacion', 'ArchivoCalificacion', RelationMap::ONE_TO_MANY, array('id' => 'archivo_id', ), null, null, 'ArchivoCalificacions');
    } // buildRelations()
