...
abstract class BaseArchivoComentarioPeer
{
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinArchivo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptArchivo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
