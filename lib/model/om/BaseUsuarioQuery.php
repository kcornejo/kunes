 ...
 * @method UsuarioQuery orderByUniversidadId($order = Criteria::ASC) Order by the universidad_id column
 * @method UsuarioQuery orderByCarreraId($order = Criteria::ASC) Order by the carrera_id column
 *
 ...
 * @method UsuarioQuery groupByUniversidadId() Group by the universidad_id column
 * @method UsuarioQuery groupByCarreraId() Group by the carrera_id column
 *
 ...
 *
 * @method UsuarioQuery leftJoinUniversidad($relationAlias = null) Adds a LEFT JOIN clause to the query using the Universidad relation
 * @method UsuarioQuery rightJoinUniversidad($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Universidad relation
 * @method UsuarioQuery innerJoinUniversidad($relationAlias = null) Adds a INNER JOIN clause to the query using the Universidad relation
 *
 * @method UsuarioQuery leftJoinCarrera($relationAlias = null) Adds a LEFT JOIN clause to the query using the Carrera relation
 * @method UsuarioQuery rightJoinCarrera($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Carrera relation
 * @method UsuarioQuery innerJoinCarrera($relationAlias = null) Adds a INNER JOIN clause to the query using the Carrera relation
 *
 * @method UsuarioQuery leftJoinUsuarioMateria($relationAlias = null) Adds a LEFT JOIN clause to the query using the UsuarioMateria relation
 * @method UsuarioQuery rightJoinUsuarioMateria($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UsuarioMateria relation
 * @method UsuarioQuery innerJoinUsuarioMateria($relationAlias = null) Adds a INNER JOIN clause to the query using the UsuarioMateria relation
 *
 ...
 *
 * @method UsuarioQuery leftJoinArchivoCalificacion($relationAlias = null) Adds a LEFT JOIN clause to the query using the ArchivoCalificacion relation
 * @method UsuarioQuery rightJoinArchivoCalificacion($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ArchivoCalificacion relation
 * @method UsuarioQuery innerJoinArchivoCalificacion($relationAlias = null) Adds a INNER JOIN clause to the query using the ArchivoCalificacion relation
 *
 ...
 * @method Usuario findOneByUniversidadId(int $universidad_id) Return the first Usuario filtered by the universidad_id column
 * @method Usuario findOneByCarreraId(int $carrera_id) Return the first Usuario filtered by the carrera_id column
 *
 ...
 * @method array findByUniversidadId(int $universidad_id) Return Usuario objects filtered by the universidad_id column
 * @method array findByCarreraId(int $carrera_id) Return Usuario objects filtered by the carrera_id column
 *
...
abstract class BaseUsuarioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USUARIO`, `CLAVE`, `CORREO`, `ESTADO`, `IMAGEN`, `ADMINISTRADOR`, `VALIDADO`, `ULTIMO_INGRESO`, `TEMA`, `FRASE`, `GENERO`, `FECHA_NACIMIENTO`, `PAIS_ID`, `CREATED_AT`, `UPDATED_AT`, `CREATED_BY`, `UPDATED_BY`, `UNIVERSIDAD_ID`, `CARRERA_ID` FROM `usuario` WHERE `ID` = :p0';
        try {
    ...
    /**
     * Filter the query on the universidad_id column
     *
     * Example usage:
     * <code>
     * $query->filterByUniversidadId(1234); // WHERE universidad_id = 1234
     * $query->filterByUniversidadId(array(12, 34)); // WHERE universidad_id IN (12, 34)
     * $query->filterByUniversidadId(array('min' => 12)); // WHERE universidad_id > 12
     * </code>
     *
     * @see       filterByUniversidad()
     *
     * @param     mixed $universidadId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return UsuarioQuery The current query, for fluid interface
     */
    public function filterByUniversidadId($universidadId = null, $comparison = null)
    {
        if (is_array($universidadId)) {
            $useMinMax = false;
            if (isset($universidadId['min'])) {
                $this->addUsingAlias(UsuarioPeer::UNIVERSIDAD_ID, $universidadId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($universidadId['max'])) {
                $this->addUsingAlias(UsuarioPeer::UNIVERSIDAD_ID, $universidadId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsuarioPeer::UNIVERSIDAD_ID, $universidadId, $comparison);
    }
    ...
    public function filterByCarreraId($carreraId = null, $comparison = null)
    {
        if (is_array($carreraId)) {
            ...
            if (isset($carreraId['min'])) {
                $this->addUsingAlias(UsuarioPeer::CARRERA_ID, $carreraId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($carreraId['max'])) {
                $this->addUsingAlias(UsuarioPeer::CARRERA_ID, $carreraId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsuarioPeer::CARRERA_ID, $carreraId, $comparison);
    }
     ...
     *
     * @param   Universidad|PropelObjectCollection $universidad The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UsuarioQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByUniversidad($universidad, $comparison = null)
    {
        if ($universidad instanceof Universidad) {
            return $this
                ->addUsingAlias(UsuarioPeer::UNIVERSIDAD_ID, $universidad->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UsuarioPeer::UNIVERSIDAD_ID, $universidad->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCarrera($carrera, $comparison = null)
    {
        if ($carrera instanceof Carrera) {
            return $this
                ->addUsingAlias(UsuarioPeer::CARRERA_ID, $carrera->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UsuarioPeer::CARRERA_ID, $carrera->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @return UsuarioQuery The current query, for fluid interface
     */
    public function joinCarrera($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useCarreraQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
    ...
    public function filterByUsuarioMateria($usuarioMateria, $comparison = null)
    {
        if ($usuarioMateria instanceof UsuarioMateria) {
            return $this
                ->addUsingAlias(UsuarioPeer::ID, $usuarioMateria->getUsuarioId(), $comparison);
    ...
    public function filterByArchivoCalificacion($archivoCalificacion, $comparison = null)
    {
        if ($archivoCalificacion instanceof ArchivoCalificacion) {
            return $this
                ->addUsingAlias(UsuarioPeer::ID, $archivoCalificacion->getUsuarioId(), $comparison);
