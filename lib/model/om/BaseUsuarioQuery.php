...
abstract class BaseUsuarioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USUARIO`, `CLAVE`, `CORREO`, `ESTADO`, `IMAGEN`, `ADMINISTRADOR`, `VALIDADO`, `ULTIMO_INGRESO`, `TEMA`, `CREATED_AT`, `UPDATED_AT`, `CREATED_BY`, `UPDATED_BY` FROM `usuario` WHERE `ID` = :p0';
        try {
