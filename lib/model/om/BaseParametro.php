...
abstract class BaseParametro extends BaseObject implements Persistent
{
    ...
    public function setValor($v)
    {
        ...
        if ($this->valor !== $v) {
            $this->valor = $v;
            $this->modifiedColumns[] = ParametroPeer::VALOR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ParametroPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ParametroPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }
        if ($this->isColumnModified(ParametroPeer::VALOR)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ParametroPeer::VALOR)) $criteria->add(ParametroPeer::VALOR, $this->valor);
