 ...
 * @method ParametroQuery orderByValor($order = Criteria::ASC) Order by the valor column
 *
 ...
 * @method ParametroQuery groupByValor() Group by the valor column
 *
 ...
 * @method Parametro findOneByValor(string $valor) Return the first Parametro filtered by the valor column
 *
 ...
 * @method array findByValor(string $valor) Return Parametro objects filtered by the valor column
 *
...
abstract class BaseParametroQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `DESCRIPCION`, `VALOR` FROM `parametro` WHERE `ID` = :p0';
        try {
    ...
    public function filterByValor($valor = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ParametroPeer::VALOR, $valor, $comparison);
    }
