...
abstract class BaseMateriaPeer
{
    ...
    /** the column name for the CATEGORIA_MATERIA_ID field */
    const CATEGORIA_MATERIA_ID = 'materia.CATEGORIA_MATERIA_ID';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'materia.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'materia.UPDATED_AT';

    /** the column name for the CREATED_BY field */
    const CREATED_BY = 'materia.CREATED_BY';

    /** the column name for the UPDATED_BY field */
    const UPDATED_BY = 'materia.UPDATED_BY';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Descripcion', 'CategoriaMateriaId', 'CreatedAt', 'UpdatedAt', 'CreatedBy', 'UpdatedBy', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'descripcion', 'categoriaMateriaId', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', ),
        BasePeer::TYPE_COLNAME => array (MateriaPeer::ID, MateriaPeer::DESCRIPCION, MateriaPeer::CATEGORIA_MATERIA_ID, MateriaPeer::CREATED_AT, MateriaPeer::UPDATED_AT, MateriaPeer::CREATED_BY, MateriaPeer::UPDATED_BY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPCION', 'CATEGORIA_MATERIA_ID', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'UPDATED_BY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'descripcion', 'categoria_materia_id', 'created_at', 'updated_at', 'created_by', 'updated_by', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Descripcion' => 1, 'CategoriaMateriaId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'CreatedBy' => 5, 'UpdatedBy' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'descripcion' => 1, 'categoriaMateriaId' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'createdBy' => 5, 'updatedBy' => 6, ),
        BasePeer::TYPE_COLNAME => array (MateriaPeer::ID => 0, MateriaPeer::DESCRIPCION => 1, MateriaPeer::CATEGORIA_MATERIA_ID => 2, MateriaPeer::CREATED_AT => 3, MateriaPeer::UPDATED_AT => 4, MateriaPeer::CREATED_BY => 5, MateriaPeer::UPDATED_BY => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPCION' => 1, 'CATEGORIA_MATERIA_ID' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'CREATED_BY' => 5, 'UPDATED_BY' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'descripcion' => 1, 'categoria_materia_id' => 2, 'created_at' => 3, 'updated_at' => 4, 'created_by' => 5, 'updated_by' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MateriaPeer::CATEGORIA_MATERIA_ID);
            $criteria->addSelectColumn(MateriaPeer::CREATED_AT);
            $criteria->addSelectColumn(MateriaPeer::UPDATED_AT);
            $criteria->addSelectColumn(MateriaPeer::CREATED_BY);
            $criteria->addSelectColumn(MateriaPeer::UPDATED_BY);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.DESCRIPCION');
            $criteria->addSelectColumn($alias . '.CATEGORIA_MATERIA_ID');
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CategoriaMateria table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCategoriaMateria(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(MateriaPeer::CATEGORIA_MATERIA_ID, CategoriaMateriaPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Materia objects pre-filled with their CategoriaMateria objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCategoriaMateria(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = CategoriaMateriaPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = CategoriaMateriaPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    CategoriaMateriaPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Materia) to $obj2 (CategoriaMateria)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CategoriaMateriaPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CategoriaMateriaPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined CategoriaMateria rows

            $key2 = CategoriaMateriaPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = CategoriaMateriaPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Materia) to the collection in $obj2 (CategoriaMateria)
                $obj2->addMateria($obj1);
