...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the universidad_id field.
     * @var        int
     */
    ...
    /**
     * @var        PropelObjectCollection|UsuarioMateria[] Collection to store aggregation of UsuarioMateria objects.
     */
    protected $collUsuarioMaterias;
    protected $collUsuarioMateriasPartial;
     ...
     */
    protected $usuarioMateriasScheduledForDeletion = null;
    ...
    /**
     * Get the [universidad_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [universidad_id] column.
     *
     * @param int $v new value
     * @return Usuario The current object (for fluent API support)
     */
    public function setUniversidadId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->universidad_id !== $v) {
            $this->universidad_id = $v;
            $this->modifiedColumns[] = UsuarioPeer::UNIVERSIDAD_ID;
        }

        if ($this->aUniversidad !== null && $this->aUniversidad->getId() !== $v) {
            $this->aUniversidad = null;
        }
    ...
    public function setCarreraId($v)
    {
        ...
        if ($this->carrera_id !== $v) {
            $this->carrera_id = $v;
            $this->modifiedColumns[] = UsuarioPeer::CARRERA_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->universidad_id = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
            $this->carrera_id = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
            $this->resetModified();
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aUniversidad !== null && $this->universidad_id !== $this->aUniversidad->getId()) {
            $this->aUniversidad = null;
        }
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aUniversidad !== null) {
                if ($this->aUniversidad->isModified() || $this->aUniversidad->isNew()) {
                    $affectedRows += $this->aUniversidad->save($con);
                }
                $this->setUniversidad($this->aUniversidad);
            }
            ...
            if ($this->usuarioMateriasScheduledForDeletion !== null) {
                if (!$this->usuarioMateriasScheduledForDeletion->isEmpty()) {
                    foreach ($this->usuarioMateriasScheduledForDeletion as $usuarioMateria) {
                        // need to save related object because we set the relation to null
                        $usuarioMateria->save($con);
                    }
                    $this->usuarioMateriasScheduledForDeletion = null;
                }
            }

            if ($this->collUsuarioMaterias !== null) {
                foreach ($this->collUsuarioMaterias as $referrerFK) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::UNIVERSIDAD_ID)) {
            $modifiedColumns[':p' . $index++]  = '`UNIVERSIDAD_ID`';
        }
        if ($this->isColumnModified(UsuarioPeer::CARRERA_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`UPDATED_BY`':
                        ...
                        break;
                    case '`UNIVERSIDAD_ID`':
                        $stmt->bindValue($identifier, $this->universidad_id, PDO::PARAM_INT);
                        break;
                    case '`CARRERA_ID`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aUniversidad !== null) {
                if (!$this->aUniversidad->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aUniversidad->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[18] => $this->getUniversidadId(),
            $keys[19] => $this->getCarreraId(),
        );
        if ($includeForeignObjects) {
            if (null !== $this->aPais) {
                $result['Pais'] = $this->aPais->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aUniversidad) {
                $result['Universidad'] = $this->aUniversidad->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aCarrera) {
                $result['Carrera'] = $this->aCarrera->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->collUsuarioMaterias) {
                $result['UsuarioMaterias'] = $this->collUsuarioMaterias->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[18], $arr)) $this->setUniversidadId($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setCarreraId($arr[$keys[19]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::UNIVERSIDAD_ID)) $criteria->add(UsuarioPeer::UNIVERSIDAD_ID, $this->universidad_id);
        if ($this->isColumnModified(UsuarioPeer::CARRERA_ID)) $criteria->add(UsuarioPeer::CARRERA_ID, $this->carrera_id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUniversidadId($this->getUniversidadId());
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getUsuarioMaterias() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addUsuarioMateria($relObj->copy($deepCopy));
                }
            }
    ...
    /**
     * Declares an association between this object and a Universidad object.
     *
     * @param             Universidad $v
     * @return Usuario The current object (for fluent API support)
     * @throws PropelException
     */
    public function setUniversidad(Universidad $v = null)
    {
        if ($v === null) {
            $this->setUniversidadId(NULL);
        } else {
            $this->setUniversidadId($v->getId());
        }

        $this->aUniversidad = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Universidad object, it will not be re-added.
        if ($v !== null) {
            $v->addUsuario($this);
        }
    ...
    /**
     * Get the associated Universidad object
     *
     * @param PropelPDO $con Optional Connection object.
     * @return Universidad The associated Universidad object.
     * @throws PropelException
     */
    public function getUniversidad(PropelPDO $con = null)
    {
        if ($this->aUniversidad === null && ($this->universidad_id !== null)) {
            $this->aUniversidad = UniversidadQuery::create()->findPk($this->universidad_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUniversidad->addUsuarios($this);
             */
        }

        return $this->aUniversidad;
    }
    ...
    public function getCarrera(PropelPDO $con = null)
    {
        if ($this->aCarrera === null && ($this->carrera_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCarrera->addUsuarios($this);
             */
        }
    ...
    {
        if ('UsuarioMateria' == $relationName) {
            $this->initUsuarioMaterias();
        }
    ...
    /**
     * Clears out the collUsuarioMaterias collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return void
     * @see        addUsuarioMaterias()
     */
    public function clearUsuarioMaterias()
    {
        $this->collUsuarioMaterias = null; // important to set this to null since that means it is uninitialized
        $this->collUsuarioMateriasPartial = null;
    }

    /**
     * reset is the collUsuarioMaterias collection loaded partially
     *
     * @return void
     */
    public function resetPartialUsuarioMaterias($v = true)
    {
        $this->collUsuarioMateriasPartial = $v;
    }

    /**
     * Initializes the collUsuarioMaterias collection.
     *
     * By default this just sets the collUsuarioMaterias collection to an empty array (like clearcollUsuarioMaterias());
     ...
     * @return void
     */
    public function initUsuarioMaterias($overrideExisting = true)
    {
        if (null !== $this->collUsuarioMaterias && !$overrideExisting) {
            return;
        }
        $this->collUsuarioMaterias = new PropelObjectCollection();
        $this->collUsuarioMaterias->setModel('UsuarioMateria');
    }

    /**
     * Gets an array of UsuarioMateria objects which contain a foreign key that references this object.
     *
     ...
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|UsuarioMateria[] List of UsuarioMateria objects
     * @throws PropelException
     */
    public function getUsuarioMaterias($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collUsuarioMateriasPartial && !$this->isNew();
        if (null === $this->collUsuarioMaterias || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collUsuarioMaterias) {
                // return empty collection
                $this->initUsuarioMaterias();
            } else {
                $collUsuarioMaterias = UsuarioMateriaQuery::create(null, $criteria)
                    ->filterByUsuario($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collUsuarioMateriasPartial && count($collUsuarioMaterias)) {
                      $this->initUsuarioMaterias(false);

                      foreach($collUsuarioMaterias as $obj) {
                        if (false == $this->collUsuarioMaterias->contains($obj)) {
                          $this->collUsuarioMaterias->append($obj);
                        }
                      }

                      $this->collUsuarioMateriasPartial = true;
                    }

                    return $collUsuarioMaterias;
                }

                if($partial && $this->collUsuarioMaterias) {
                    foreach($this->collUsuarioMaterias as $obj) {
                        if($obj->isNew()) {
                            $collUsuarioMaterias[] = $obj;
                        }
                    }
                }

                $this->collUsuarioMaterias = $collUsuarioMaterias;
                $this->collUsuarioMateriasPartial = false;
            }
        }

        return $this->collUsuarioMaterias;
    }

    /**
     * Sets a collection of UsuarioMateria objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $usuarioMaterias A Propel collection.
     * @param PropelPDO $con Optional connection object
     */
    ...
    /**
     * Returns the number of related UsuarioMateria objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related UsuarioMateria objects.
     * @throws PropelException
     */
    public function countUsuarioMaterias(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collUsuarioMateriasPartial && !$this->isNew();
        if (null === $this->collUsuarioMaterias || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collUsuarioMaterias) {
                ...
                if($partial && !$criteria) {
                    return count($this->getUsuarioMaterias());
                }
                $query = UsuarioMateriaQuery::create(null, $criteria);
                if ($distinct) {
                    $query->distinct();
                }
            ...
            return count($this->collUsuarioMaterias);
        }
    }

    /**
     * Method called to associate a UsuarioMateria object to this object
     * through the UsuarioMateria foreign key attribute.
     *
     * @param    UsuarioMateria $l UsuarioMateria
     * @return Usuario The current object (for fluent API support)
     */
    public function addUsuarioMateria(UsuarioMateria $l)
    {
        if ($this->collUsuarioMaterias === null) {
            $this->initUsuarioMaterias();
            $this->collUsuarioMateriasPartial = true;
        }
        if (!$this->collUsuarioMaterias->contains($l)) { // only add it if the **same** object is not already associated
            $this->doAddUsuarioMateria($l);
        }
    ...
    /**
     * @param	UsuarioMateria $usuarioMateria The usuarioMateria object to add.
     */
    protected function doAddUsuarioMateria($usuarioMateria)
    {
        $this->collUsuarioMaterias[]= $usuarioMateria;
        $usuarioMateria->setUsuario($this);
    }

    /**
     * @param	UsuarioMateria $usuarioMateria The usuarioMateria object to remove.
     */
    public function removeUsuarioMateria($usuarioMateria)
    {
        if ($this->getUsuarioMaterias()->contains($usuarioMateria)) {
            $this->collUsuarioMaterias->remove($this->collUsuarioMaterias->search($usuarioMateria));
            if (null === $this->usuarioMateriasScheduledForDeletion) {
                $this->usuarioMateriasScheduledForDeletion = clone $this->collUsuarioMaterias;
                $this->usuarioMateriasScheduledForDeletion->clear();
            }
            $this->usuarioMateriasScheduledForDeletion[]= $usuarioMateria;
     ...
     * been saved, it will retrieve related UsuarioMaterias from storage.
     *
     ...
     * @return PropelObjectCollection|UsuarioMateria[] List of UsuarioMateria objects
     */
    public function getUsuarioMateriasJoinMateria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UsuarioMateriaQuery::create(null, $criteria);
        $query->joinWith('Materia', $join_behavior);

        return $this->getUsuarioMaterias($query, $con);
    }
     ...
     * @return PropelObjectCollection|Archivo[] List of Archivo objects
     */
    public function getArchivosJoinMateria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ArchivoQuery::create(null, $criteria);
        $query->joinWith('Materia', $join_behavior);

        return $this->getArchivos($query, $con);
    }
     ...
     * @return PropelObjectCollection|Archivo[] List of Archivo objects
     */
    public function getArchivosJoinProfesores($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ArchivoQuery::create(null, $criteria);
        $query->joinWith('Profesores', $join_behavior);
    ...
    public function setArchivoCalificacions(PropelCollection $archivoCalificacions, PropelPDO $con = null)
    {
        ...
        foreach ($this->archivoCalificacionsScheduledForDeletion as $archivoCalificacionRemoved) {
            $archivoCalificacionRemoved->setUsuario(null);
        }
    ...
    protected function doAddArchivoCalificacion($archivoCalificacion)
    {
        ...
        $archivoCalificacion->setUsuario($this);
    }
    ...
    public function removeArchivoCalificacion($archivoCalificacion)
    {
        if ($this->getArchivoCalificacions()->contains($archivoCalificacion)) {
            ...
            $archivoCalificacion->setUsuario(null);
        }
    }
     ...
     * @return PropelObjectCollection|ArchivoCalificacion[] List of ArchivoCalificacion objects
     */
    public function getArchivoCalificacionsJoinArchivo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ArchivoCalificacionQuery::create(null, $criteria);
        $query->joinWith('Archivo', $join_behavior);
    ...
    {
        if ($deep) {
            if ($this->collUsuarioMaterias) {
                foreach ($this->collUsuarioMaterias as $o) {
        ...
        if ($this->collUsuarioMaterias instanceof PropelCollection) {
            $this->collUsuarioMaterias->clearIterator();
        }
        $this->collUsuarioMaterias = null;
