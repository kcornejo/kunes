...
abstract class BaseTokenPeer
{
    ...
    const CREATED_BY = 'token.CREATED_BY';

    /** the column name for the UPDATED_BY field */
    const UPDATED_BY = 'token.UPDATED_BY';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UsuarioId', 'Clave', 'CreatedAt', 'UpdatedAt', 'CreatedBy', 'UpdatedBy', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuarioId', 'clave', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID, TokenPeer::USUARIO_ID, TokenPeer::CLAVE, TokenPeer::CREATED_AT, TokenPeer::UPDATED_AT, TokenPeer::CREATED_BY, TokenPeer::UPDATED_BY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USUARIO_ID', 'CLAVE', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'UPDATED_BY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'usuario_id', 'clave', 'created_at', 'updated_at', 'created_by', 'updated_by', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UsuarioId' => 1, 'Clave' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'CreatedBy' => 5, 'UpdatedBy' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuarioId' => 1, 'clave' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'createdBy' => 5, 'updatedBy' => 6, ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID => 0, TokenPeer::USUARIO_ID => 1, TokenPeer::CLAVE => 2, TokenPeer::CREATED_AT => 3, TokenPeer::UPDATED_AT => 4, TokenPeer::CREATED_BY => 5, TokenPeer::UPDATED_BY => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USUARIO_ID' => 1, 'CLAVE' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'CREATED_BY' => 5, 'UPDATED_BY' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'usuario_id' => 1, 'clave' => 2, 'created_at' => 3, 'updated_at' => 4, 'created_by' => 5, 'updated_by' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TokenPeer::CLAVE);
            $criteria->addSelectColumn(TokenPeer::CREATED_AT);
            $criteria->addSelectColumn(TokenPeer::UPDATED_AT);
            $criteria->addSelectColumn(TokenPeer::CREATED_BY);
            $criteria->addSelectColumn(TokenPeer::UPDATED_BY);
        } else {
