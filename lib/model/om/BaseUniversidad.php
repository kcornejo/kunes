...
/**
 * Base class that represents a row from the 'universidad' table.
 *
 *
 *
 ...
 */
abstract class BaseUniversidad extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UniversidadPeer';
     ...
     * @return Universidad The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UniversidadPeer::ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = UniversidadPeer::DESCRIPCION;
        }
    ...
    public function setPaisId($v)
    {
        ...
        if ($this->pais_id !== $v) {
            $this->pais_id = $v;
            $this->modifiedColumns[] = UniversidadPeer::PAIS_ID;
        }
    ...
    public function setCantidadRating($v)
    {
        ...
        if ($this->cantidad_rating !== $v) {
            ...
            $this->modifiedColumns[] = UniversidadPeer::CANTIDAD_RATING;
        }
    ...
    public function setRating($v)
    {
        ...
        if ($this->rating !== $v) {
            $this->rating = $v;
            $this->modifiedColumns[] = UniversidadPeer::RATING;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UniversidadPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UniversidadPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = UniversidadPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = UniversidadPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cantidad_rating = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 9; // 9 = UniversidadPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Universidad object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UniversidadPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UniversidadQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseUniversidad:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseUniversidad:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseUniversidad:save:pre') as $callable)
            {
            ...
            if ($this->isModified() && !$this->isColumnModified(UniversidadPeer::UPDATED_AT))
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(UniversidadPeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseUniversidad:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                UniversidadPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UniversidadPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(UniversidadPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }
        if ($this->isColumnModified(UniversidadPeer::PAIS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PAIS_ID`';
        }
        if ($this->isColumnModified(UniversidadPeer::CANTIDAD_RATING)) {
            $modifiedColumns[':p' . $index++]  = '`CANTIDAD_RATING`';
        }
        if ($this->isColumnModified(UniversidadPeer::RATING)) {
            $modifiedColumns[':p' . $index++]  = '`RATING`';
        }
        if ($this->isColumnModified(UniversidadPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(UniversidadPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }
        if ($this->isColumnModified(UniversidadPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_BY`';
        }
        if ($this->isColumnModified(UniversidadPeer::UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_BY`';
        }

        $sql = sprintf(
            'INSERT INTO `universidad` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UniversidadPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UniversidadPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Universidad'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Universidad'][$this->getPrimaryKey()] = true;
        $keys = UniversidadPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDescripcion(),
            $keys[2] => $this->getPaisId(),
            $keys[3] => $this->getCantidadRating(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setPaisId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setCantidadRating($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UniversidadPeer::ID)) $criteria->add(UniversidadPeer::ID, $this->id);
        if ($this->isColumnModified(UniversidadPeer::DESCRIPCION)) $criteria->add(UniversidadPeer::DESCRIPCION, $this->descripcion);
        if ($this->isColumnModified(UniversidadPeer::PAIS_ID)) $criteria->add(UniversidadPeer::PAIS_ID, $this->pais_id);
        if ($this->isColumnModified(UniversidadPeer::CANTIDAD_RATING)) $criteria->add(UniversidadPeer::CANTIDAD_RATING, $this->cantidad_rating);
        if ($this->isColumnModified(UniversidadPeer::RATING)) $criteria->add(UniversidadPeer::RATING, $this->rating);
        if ($this->isColumnModified(UniversidadPeer::CREATED_AT)) $criteria->add(UniversidadPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(UniversidadPeer::UPDATED_AT)) $criteria->add(UniversidadPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(UniversidadPeer::CREATED_BY)) $criteria->add(UniversidadPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(UniversidadPeer::UPDATED_BY)) $criteria->add(UniversidadPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(UniversidadPeer::DATABASE_NAME);
        $criteria->add(UniversidadPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Universidad (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Universidad Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UniversidadPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UniversidadPeer();
        }
    ...
    public function getPais(PropelPDO $con = null)
    {
        if ($this->aPais === null && ($this->pais_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPais->addUniversidads($this);
             */
        }
     ...
     * If this Universidad is new, it will return
    ...
    public function setUsuarios(PropelCollection $usuarios, PropelPDO $con = null)
    {
        ...
        foreach ($this->usuariosScheduledForDeletion as $usuarioRemoved) {
            $usuarioRemoved->setUniversidad(null);
        }
     ...
     * Otherwise if this Universidad is new, it will return
     * an empty collection; or if this Universidad has previously
     * been saved, it will retrieve related Usuarios from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Universidad.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Usuario[] List of Usuario objects
     */
    public function getUsuariosJoinPais($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UsuarioQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(UniversidadPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseUniversidad:' . $name))
        {
