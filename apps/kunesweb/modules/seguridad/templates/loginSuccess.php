    ...
    <body class="login">
        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo url_for('seguridad/login') ?>" method="post">
                ...
                <h3 class="form-title"><b>Ingreso a Anarchivos</b></h3>
                ...
                <div class="form-group">
                    ...
                    <span style="float:right">
                        <br/>
                        <a href="<?php echo url_for('seguridad/recuperaclave')?>" class="btn btn-xs btn-warning">
                            Recuperar clave
                        </a>
                    </span>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a style="float:right" class="btn green align-rt" href="<?php echo url_for('seguridad/registrar') ?>">
