<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
    ...
    <?php if (sfContext::getInstance()->getUser()->getAttribute('administrador', null, 'seguridad')): ?>
        <li>
            ...
            <ul class="sub-menu">
                <li>
                    <a href="<?php echo url_for('archivo/index') ?>">
        ...
        <li>
            ...
            <ul class="sub-menu">
                <li>
                    <a href="<?php echo url_for('pais/index') ?>">
                        <i class="fa fa-check"></i>
                        Paises
                    </a>
                </li>
                <li>
                    <a href="<?php echo url_for('universidad/index') ?>">
                        <i class="fa fa-check"></i>
                        Universidades
                    </a>
                </li>
                ...
                <li>
                    <a href="<?php echo url_for('materia/index') ?>">
                        <i class="fa fa-check"></i>
                        Materia
                    </a>
                </li>
        ...
        <li>
            ...
            <ul class="sub-menu">
                <li>
                    <a href="<?php echo url_for('configuracion_correo/index') ?>">
                ...
                <li>
                    <a href="<?php echo url_for('formato_correo/index') ?>">
                        <i class="fa fa-inbox"></i>
                        Formato para Envio de Correo
                    </a>
                </li>
            </ul>
        </li>
