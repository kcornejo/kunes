...
class myUser extends sfBasicSecurityUser {
    ...
    public function graficaPie() {
        ...
        return $grafica;
         ...
         public function HojaEncabezado($hoja, $titulo, $filtros) {
      ...
      public function HojaImprimeEncabezadoHorizontal($lista, $columna, $fila, $hoja) {
        foreach ($lista as $registro) {
            ...
            $hoja->getStyle($letra . $fila)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('FFe0e0e0');
