...
<html lang="en">
    ...
    <head>
        ...
        <link href="/assets/plugins/tags/css/jquery.tagit.css" rel="stylesheet" type="text/css"/>
        <link href="/assets/plugins/tags/css/tagit.ui-zendesk.css" rel="stylesheet" type="text/css"/>
...
?>
    ...
    <?php if (sfContext::getInstance()->getUser()->getAttribute('administrador', null, 'seguridad')): ?>
            ...
            <div class="page-header-inner">
                ...
                <form class="search-form" action="javascript:;" method="GET">
                    <div class="input-group">
                        <input class="form-control" autocomplete="off" id="buscador_general"  placeholder="Buscar..." name="query" type="text">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    <?php echo include_partial('soporte/menu') ?>
                    <!-- END SIDEBAR MENU -->
                </div>
            </div>
            <!-- END SIDEBAR -->
